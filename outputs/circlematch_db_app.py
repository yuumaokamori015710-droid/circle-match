...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;background:#f4f7fa;color:var(--ink);font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;letter-spacing:0}
    ...
    .map-board{padding:18px;background:linear-gradient(180deg,#fff,#f7fbf1)}.map-headline{margin:0 0 16px;font-size:25px;font-weight:950;line-height:1.25}.map-headline strong{color:var(--accent);font-size:38px}.map-stage{position:relative;min-height:520px;border:1px solid #d7e4cc;border-radius:8px;overflow:hidden;background:radial-gradient(circle at 58% 42%,rgba(157,207,79,.14),transparent 34%),linear-gradient(135deg,#fbfdf8,#eef7e6)}.japan-silhouette{position:absolute;left:19%;top:12%;width:62%;height:78%;filter:drop-shadow(0 9px 13px rgba(49,111,31,.22))}.japan-silhouette path,.japan-silhouette ellipse{fill:#83c945;stroke:#fff;stroke-width:5;stroke-linejoin:round}.map-region{position:absolute;z-index:2;display:grid;gap:3px;min-width:112px;padding:9px 12px;border:1px solid #cbd7e2;border-radius:8px;background:linear-gradient(#fff,#f2f5f8);box-shadow:0 6px 15px rgba(27,45,69,.12);color:var(--ink);text-align:center;text-decoration:none;font-weight:900}.map-region:hover{border-color:var(--accent);box-shadow:0 10px 20px rgba(225,91,49,.18);transform:translateY(-2px)}.map-region span{color:#516680;font-size:12px;font-weight:850}.pos-hokkaido{right:10%;top:8%}.pos-tohoku{right:7%;top:33%}.pos-kanto{right:19%;bottom:9%}.pos-chubu{left:45%;top:16%}.pos-kansai{left:32%;top:25%}.pos-chugoku_shikoku{left:16%;top:35%}.pos-kyushu{left:6%;top:50%}
    ...
    @media(max-width:900px){.stats{grid-template-columns:repeat(2,minmax(0,1fr));margin-top:12px}.filters{grid-template-columns:1fr 1fr}.match-grid{grid-template-columns:1fr}.sport-grid{grid-template-columns:1fr}.hero{min-height:520px}.map-stage{min-height:500px}.japan-silhouette{left:8%;width:78%}.map-region{min-width:104px}}
    @media(max-width:760px){.map-headline{font-size:20px}.map-headline strong{font-size:30px}.map-stage{min-height:auto;padding:14px;display:grid;gap:12px}.japan-silhouette{position:relative;left:auto;top:auto;width:100%;height:auto;max-height:320px}.map-region{position:relative;inset:auto!important;min-width:0}.map-region-buttons{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}}
...
<body>
  ...
  <main>
    ...
    <section class="section panel"><div class="panel-head"><div><h2>地域から探す</h2><p>地図上の地域を押すと、募集掲示板とDB候補をその地域で絞り込めます。</p></div></div><div class="map-board"><p class="map-headline"><strong id="mapCircleCount">0</strong>件の大学サークル候補から地域で探す</p><div class="map-stage"><svg class="japan-silhouette" viewBox="0 0 640 560" role="img" aria-label="日本地図"><path d="M445 28c47 12 83 50 92 95-38 10-80 5-108-20-25-22-29-50 16-75Z"/><path d="M426 134c38 21 66 56 73 102-12 28-34 50-65 67-24-25-44-58-48-96-3-31 9-57 40-73Z"/><path d="M372 254c37 22 57 58 54 101-31 14-71 16-104 2-20-28-16-68 7-94 12-13 27-18 43-9Z"/><path d="M276 314c34 2 63 18 85 46-8 33-31 56-68 70-42-9-72-29-91-58 12-34 37-54 74-58Z"/><path d="M126 365c45-25 90-24 137 3-6 35-32 62-78 81-56-6-96-23-121-50 15-12 36-24 62-34Z"/><path d="M55 435c37-15 73-12 108 10-4 36-27 64-68 85-30-16-48-39-54-68 3-11 8-20 14-27Z"/><ellipse cx="92" cy="520" rx="18" ry="31" transform="rotate(-25 92 520)"/><ellipse cx="508" cy="405" rx="16" ry="24" transform="rotate(26 508 405)"/></svg><div class="map-region-buttons" id="regionGrid"></div></div></div></section>
  </main>
