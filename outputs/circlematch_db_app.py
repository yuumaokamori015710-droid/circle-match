...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;background:#f4f7fa;color:var(--ink);font-family:system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;letter-spacing:0}
    ...
    .map-board{padding:18px;background:linear-gradient(180deg,#fff,#f7fbf1)}.map-headline{margin:0 0 16px;font-size:25px;font-weight:950;line-height:1.25}.map-headline strong{color:var(--accent);font-size:38px}.map-stage{position:relative;min-height:560px;border:1px solid #d7e4cc;border-radius:8px;overflow:hidden;background:radial-gradient(circle at 44% 48%,rgba(157,207,79,.14),transparent 34%),linear-gradient(135deg,#fbfdf8,#eef7e6)}.japan-silhouette{position:absolute;left:10%;top:8%;width:58%;height:84%;filter:drop-shadow(0 9px 13px rgba(49,111,31,.22))}.japan-silhouette .country{fill:#83c945;stroke:#fff;stroke-width:1.2;stroke-linejoin:round}.japan-silhouette .outline{fill:none;stroke:rgba(49,111,31,.22);stroke-width:1.8}.map-region-buttons{position:absolute;right:22px;top:22px;z-index:2;display:grid;grid-template-columns:1fr;gap:8px;width:170px}.map-region{display:grid;gap:3px;padding:8px 11px;border:1px solid #cbd7e2;border-radius:8px;background:linear-gradient(rgba(255,255,255,.96),rgba(242,245,248,.94));box-shadow:0 6px 15px rgba(27,45,69,.12);color:var(--ink);text-align:center;text-decoration:none;font-weight:900;backdrop-filter:blur(3px)}.map-region:hover{border-color:var(--accent);box-shadow:0 10px 20px rgba(225,91,49,.18);transform:translateY(-2px)}.map-region span{color:#516680;font-size:12px;font-weight:850}
